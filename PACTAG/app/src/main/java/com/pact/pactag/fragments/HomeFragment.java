...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //recup recycler view
        RecyclerView horizontalRecyclerView = (RecyclerView)view.findViewById(R.id.horizontal_recycler_view);
        horizontalRecyclerView.setAdapter(new PlantAdapter(R.layout.item_horizontal_plant, plantList, this.context));

        //recup le second recycler view
        RecyclerView verticalRecyclerView = (RecyclerView)view.findViewById(R.id.vertical_recycler_view);
