...
|sujet | Maxime, Dário, Guilhem| 25 oct.| |
|sujet en anglais |Bounlhom, Guilhem | 26 oct.| |
|scenario |Andrey, Maxime | 5 nov| |
|architecture (schéma et documentation) | Aymane, Dário| 5 nov | |
|découpage en modules |Andrey | 5 nov | |
|planning temporel (ce document, personnalisé) | Bounlhom, Aymane| 1 nov. | |
|====
