...
|sujet | Maxime, Dário, Guilhem| 25 oct.| fait avant le planning |
|sujet en anglais |Bounlhom, Guilhem | 26 oct.| fait|
|scenario |Andrey, Maxime | 5 nov| fait|
|architecture (schéma et documentation) | Aymane, Dário| 5 nov | fait|
