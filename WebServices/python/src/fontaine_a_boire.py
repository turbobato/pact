...
request = "http://opendata.paris.fr/api/records/1.0/search/?dataset=fontaines-a-boire&q="+q+"&rows="+rows+"BA&facet=type_objet&facet=modele&facet=commune&facet=dispo"
...
if (results == []):
    print("Aucune réponse ne satisfaisant votre reqûete a été trouvée")
